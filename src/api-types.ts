...
export interface SagaQueryApi<Ctx extends ApiCtx = ApiCtx>
  ...
  uri: (uri: string) => {
    ...
    get<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
    get<P, ApiSuccess>(req: {
      saga?: any;
    }): CreateActionWithPayload<
      Omit<Ctx, 'payload' | 'json'> & Payload<P> & FetchJson<ApiSuccess>,
      P
    >;
     ...
     */
    get(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    post<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    post(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    put<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    put(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    patch<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    patch(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    delete<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    delete(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    options<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    options(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    head<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    head(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    connect<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    connect(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
    ...
    trace<P extends never, ApiSuccess>(req: {
      saga?: any;
    }): CreateAction<Omit<Ctx, 'json'> & FetchJson<ApiSuccess>>;
     ...
     * Options and Middleware
     */
    trace(req: { saga?: any }, fn: MiddlewareApiCo<Ctx>): CreateAction<Ctx>;
